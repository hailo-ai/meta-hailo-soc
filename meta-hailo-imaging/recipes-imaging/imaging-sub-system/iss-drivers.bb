...
SRC_URI = "git://git@github.com/hailo-ai/hailo-imaging.git;protocol=https;branch=0.0.0.LGL-dv-LGL_13"
SRCREV = "068d2ce7443b5c732b1af825c9d32b7dc75b747c"
S = "${WORKDIR}/git"

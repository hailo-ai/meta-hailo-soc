...
SRC_URI = "git://git@github.com/hailo-ai/hailo-media-library.git;protocol=https;branch=8.8.8-dv-1"
SRC_URI += "https://hailo-hailort.s3.eu-west-2.amazonaws.com/${HAILO_PLATFORM_NAME}/8.8.8-dv-1/hefs.tar.gz;name=hefs_${HAILO_SOC_NAME}"
SRCREV = "17d0a0f5c322db94d4192cd0504a7d758b11ba3e"

...
SRC_URI = "git://git@github.com/hailo-ai/hailo-media-library.git;protocol=https;branch=1.11.0-dv-LGL_34"
SRC_URI += "https://hailo-hailort.s3.eu-west-2.amazonaws.com/${HAILO_PLATFORM_NAME}/1.11.0-dv-LGL_34/hefs.tar.gz;name=hefs_${HAILO_SOC_NAME}"
SRCREV = "04f47820fc4bccf648984d3b3dd05e86039e4818"

...
SRC_URI = "git://git@github.com/hailo-ai/hailo-media-library.git;protocol=https;branch=0.0.0.LGL-dv-LGL_23"
SRC_URI += "https://hailo-hailort.s3.eu-west-2.amazonaws.com/${HAILO_PLATFORM_NAME}/0.0.0.LGL-dv-LGL_23/hefs.tar.gz;name=hefs_${HAILO_SOC_NAME}"
SRCREV = "3f34356f0a16ffd41b13ade44d88688bca857797"

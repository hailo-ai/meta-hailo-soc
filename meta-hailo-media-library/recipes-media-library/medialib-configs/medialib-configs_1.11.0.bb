...
SRC_URI = "git://git@github.com/hailo-ai/hailo-media-library.git;protocol=https;branch=1.11.0-dv-LGL_35"
SRC_URI += "https://hailo-hailort.s3.eu-west-2.amazonaws.com/${HAILO_PLATFORM_NAME}/1.11.0-dv-LGL_35/hefs.tar.gz;name=hefs_${HAILO_SOC_NAME}"
SRCREV = "c668f61cec818aa9b81c54b9c2d4c1ffd3c6437f"

...
SRC_URI = "git://git@github.com/hailo-ai/hailo-media-library.git;protocol=https;branch=0.0.0.LGL-dv-LGL_16"
SRC_URI += "https://hailo-hailort.s3.eu-west-2.amazonaws.com/${HAILO_PLATFORM_NAME}/0.0.0.LGL-dv-LGL_16/hefs.tar.gz;name=hefs_${HAILO_SOC_NAME}"
SRCREV = "1c07a9530ad8b68434b8c66201ffe7cd97af5d26"

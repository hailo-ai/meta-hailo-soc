...
SRC_URI = "git://git@github.com/hailo-ai/hailo-media-library.git;protocol=https;branch=0.0.0.LGL-dv-LGL_26"
SRC_URI += "https://hailo-hailort.s3.eu-west-2.amazonaws.com/${HAILO_PLATFORM_NAME}/0.0.0.LGL-dv-LGL_26/hefs.tar.gz;name=hefs_${HAILO_SOC_NAME}"
SRCREV = "7ceffbbac76c392028ec44a49a4e014c8b3bdcf9"

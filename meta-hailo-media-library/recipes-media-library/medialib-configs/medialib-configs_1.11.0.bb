...
SRC_URI = "git://git@github.com/hailo-ai/hailo-media-library.git;protocol=https;branch=0.0.0.LGL-dv-LGL_25"
SRC_URI += "https://hailo-hailort.s3.eu-west-2.amazonaws.com/${HAILO_PLATFORM_NAME}/0.0.0.LGL-dv-LGL_25/hefs.tar.gz;name=hefs_${HAILO_SOC_NAME}"
SRCREV = "8f3a57a2ac2102df1548019c1614d0af673bd686"

...
SRC_URI = "git://git@github.com/hailo-ai/hailo-media-library.git;protocol=https;branch=1.12.1-dv-7"
SRC_URI += "https://hailo-hailort.s3.eu-west-2.amazonaws.com/${HAILO_PLATFORM_NAME}/1.12.1-dv-7/hefs.tar.gz;name=hefs_${HAILO_SOC_NAME}"
SRCREV = "5832dd841d666870ae23b88dea8a04c379b61c5f"

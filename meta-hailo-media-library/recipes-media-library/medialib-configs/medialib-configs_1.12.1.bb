...
SRC_URI = "git://git@github.com/hailo-ai/hailo-media-library.git;protocol=https;branch=1.12.1-dv-3"
SRC_URI += "https://hailo-hailort.s3.eu-west-2.amazonaws.com/${HAILO_PLATFORM_NAME}/1.12.1-dv-3/hefs.tar.gz;name=hefs_${HAILO_SOC_NAME}"
SRCREV = "6b0ad95d9aa0ada1407bcd09d4695dea363d6fe6"

...
SRC_URI = "git://git@github.com/hailo-ai/hailo-media-library.git;protocol=https;branch=1.12.1-dv-6"
SRC_URI += "https://hailo-hailort.s3.eu-west-2.amazonaws.com/${HAILO_PLATFORM_NAME}/1.12.1-dv-6/hefs.tar.gz;name=hefs_${HAILO_SOC_NAME}"
SRCREV = "71e325509480a848cfa21ab2635a721bdf5cfe46"

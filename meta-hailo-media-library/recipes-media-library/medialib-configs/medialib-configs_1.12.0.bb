...
SRC_URI = "git://git@github.com/hailo-ai/hailo-media-library.git;protocol=https;branch=1.12.0-dv-3"
SRC_URI += "https://hailo-hailort.s3.eu-west-2.amazonaws.com/${HAILO_PLATFORM_NAME}/1.12.0-dv-3/hefs.tar.gz;name=hefs_${HAILO_SOC_NAME}"
SRCREV = "5be57cbbfcd4a62df1ee481a727f2039de62edc5"

...
S3_URI = "https://hailo-hailort.s3.eu-west-2.amazonaws.com/${HAILO_PLATFORM_NAME}/1.12.1-dv-2/dsp-fw"
FW = "dsp-fw.elf"

SRC_URI = "${S3_URI}/${FW};name=fw_${HAILO_SOC_NAME} \
           ${S3_URI}/LICENSE;name=lic"

SRC_URI[fw_hailo15.sha256sum] = "084b539378128d925d91a98139d2be93cc29ad704e78b0856728bb0f845fe1ed"
SRC_URI[fw_hailo15l.sha256sum] = "f0e053dad309a9208636bd55d28093c6496df2c3a7d9474519089fd548007cc0"

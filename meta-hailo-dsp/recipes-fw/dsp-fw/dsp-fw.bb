...
S3_URI = "https://hailo-hailort.s3.eu-west-2.amazonaws.com/Hailo15/1.1.1/dsp-fw"
FW = "dsp-fw.elf"

SRC_URI = "${S3_URI}/${FW};name=fw \
           ${S3_URI}/LICENSE;name=lic"

SRC_URI[fw.sha256sum] = "a9421ff7f6927ee0463cc1622f60eb540258feb5cfbb12ced0f025a2b56c04e4"

...
S3_URI = "https://hailo-hailort.s3.eu-west-2.amazonaws.com/Hailo15/1.7.4/dsp-fw"
FW = "dsp-fw.elf"

SRC_URI = "${S3_URI}/${FW};name=fw \
           ${S3_URI}/LICENSE;name=lic"

SRC_URI[fw.sha256sum] = "43c56b20eecd33d1405f695787da2436f50a1b1829d5d3be1e28e596f030487f"

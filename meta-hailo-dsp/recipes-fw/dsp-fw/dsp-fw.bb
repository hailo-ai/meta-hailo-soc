...
S3_URI = "https://hailo-hailort.s3.eu-west-2.amazonaws.com/${HAILO_PLATFORM_NAME}/1.12.0-dv-dv-7/dsp-fw"
FW = "dsp-fw.elf"

SRC_URI = "${S3_URI}/${FW};name=fw_${HAILO_SOC_NAME} \
           ${S3_URI}/LICENSE;name=lic"

SRC_URI[fw_hailo15.sha256sum] = "57e25821199d8e8c63f3b29dca2b7b72e556178d117b920deb83963614bc880d"
SRC_URI[fw_hailo15l.sha256sum] = "25bf81201c6c61a11bbebe0aa24f8cb694ba33d59f55fcb48be1fd30b2148a8d"
